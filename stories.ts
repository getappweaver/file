...
const demoDiff = {
  ...
  binary: false,
  lines: [
    { kind: 'header', text: 'diff --git a/README.md b/README.md' },
    { kind: 'header', text: 'index 7b3a20a..a91c15e 100644' },
    { kind: 'header', text: '--- a/README.md' },
    { kind: 'header', text: '+++ b/README.md' },
    { kind: 'hunk', text: '@@ -12,6 +12,9 @@ AppWeaver' },
    { kind: 'context', text: ' - Install apps as plugins' },
    { kind: 'context', text: ' - Run agent workflows from chat' },
    { kind: 'add', text: '+- Preview plugin stories in the web demo' },
    { kind: 'add', text: '+- Browse files with markdown and diff views' },
    { kind: 'context', text: ' - Keep all changes reviewable' },
  ],
